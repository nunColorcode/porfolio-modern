...
export default function HomePage() {
    ...
    return (
        <div className="flex justify-between min-h-screen mt-42 max-w-6xl mx-auto">
            <div className="w-[80%] ustify-start  max-w-2xl gap-3 px-16 mx-auto">
            <div className="relative h-[200px] w-[200px] group">
                        <div aria-hidden className="pointer-events-none absolute inset-0 rounded-full p-[2px]">
                        ...
                        <Image src="/logo.png" alt="home" width={200} height={200} className="rounded-full hero-img grayscale group-hover:grayscale-0 group-hover:brightness-110 transition duration-300 relative z-10" />
                    </div>
